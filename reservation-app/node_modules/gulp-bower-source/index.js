// const PLUGIN_NAME = "gulp-bower-src";
...
// var gulpBowerSrc = function( opts ) {
  
//   opts = opts || {};


//   // Check if the file defined in bower_src exists on disk
//   if( !opts.bower_src && fs.existsSync( opts.bower_src ) ) {
//     //read bower.json
//     var bowerJSON = JSON.parse(fs.readFileSync(opts.bower_src));

//   } else if ( fs.existsSync( './bower.json' ) ) {
//     // opts.bower_src is empty, try to read bower.json
//     var bowerJSON = JSON.parse(fs.readFileSync( './bower.json' ));

//   } else if ( fs.existsSync( './bower_components' ) ) {
//     // bower_src is empty, unable to find bower.json - try to read ./bower_components

//   } else if ( fs.existsSync( './.bowerrc' ) ) {
//     // bower_src is empty, unable to find bower.json, unable to read ./bower_components - try to read ./bowerrc

//   } else {
//     // Unable to find any bower related files: bower.json, ./bower_components, ./bowerrc
//     throw new PluginError(PLUGIN_NAME, 'Bower components directory does not exist or bower.json' );
//   }
